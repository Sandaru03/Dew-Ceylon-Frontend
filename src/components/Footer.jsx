      ...
      <div className="footer-container">
        ...
        <div className="footer-main-grid">
          ...
          <div className="footer-brand animate-fade-in-up" style={{animationDelay: '0.1s'}}>
            <h2 className="footer-logo-text">DEW CEYLON.</h2>
            <p className="footer-brand-desc">
              Curating wild realities and unparalleled safari dreams. 
              Your ultimate travel partner for exploring the untouched 
              beauty of Sri Lanka and beyond.
            </p>
          </div>
          ...
          <div className="footer-links animate-fade-in-up" style={{animationDelay: '0.3s'}}>
            <h3>DESTINATIONS</h3>
            <ul>
              <li><a href="#">Sri Lanka Safari</a></li>
              <li><a href="#">African Plains</a></li>
              <li><a href="#">Island Retreats</a></li>
              <li><a href="#">Himalayan Quests</a></li>
            </ul>
          </div>
